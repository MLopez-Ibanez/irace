...
#> 0.866395909963976
#> 0.867383245092458
#> # 2026-01-16 18:26:35 UTC: Starting ablation from 1 to 128
#> # Seed: 1234567
...
#>     tmax    temp
#> 128  191 40.5608
#> # 2026-01-16 18:26:35 UTC: Executing source and target configurations on the given instances * nrep (50)...
#> # Generating configurations (row number is ID): tmax temp 
#>   tmax    temp
#> 3  191 22.9982
#> 4 1674 40.5608
#> # 2026-01-16 18:26:37 UTC: Ablation (full) of 2 configurations on 50 instances (this may take a while ...).
#> # Best changed parameters:
#> # temp : 22.9982 -> 40.5608 
#> # 2026-01-16 18:26:39 UTC: Final best configuration:
#>   tmax    temp
#> 2  191 40.5608
plotAblation(ablog)
...
#> 0.866395909963976
#> 0.867383245092458
#> # 2026-01-16 18:26:39 UTC: Starting ablation from 1 to 10
#> # Seed: 1234567
#> # Source configuration (row number is ID):
#>   tmax    temp
#> 1 1674 22.9982
...
#>    tmax    temp
#> 10 2612 54.2482
#> # 2026-01-16 18:26:39 UTC: Executing source and target configurations on the given instances * nrep (50)...
#> # 2026-01-16 18:26:42 UTC: Final best configuration:
#>   tmax    temp
#> 2 2612 54.2482
