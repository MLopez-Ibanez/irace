...
#> # 2026-01-28 22:19:56 UTC: Checking scenario
#> ## irace scenario:
...
#> # 2026-01-28 22:19:56 UTC: Checking target runner.
#> # 2026-01-28 22:19:56 UTC: Executing targetRunner (2 times)...
...
#> 
#> 
#> # 2026-01-28 22:19:56 UTC: Check successful.
#> [1] TRUE
...
#> # 2026-01-28 22:19:56 UTC: Initialization
#> # Elitist race
...
#> # deterministic: FALSE
#> 
#> # 2026-01-28 22:19:56 UTC: Iteration 1 of 3
#> # experimentsUsed: 0
#> # remainingBudget: 500
#> # currentBudget: 166
#> # nbConfigurations: 27
...
#> 21   21   12 30.9332       NA
#> 
#> # 2026-01-28 22:19:57 UTC: Elite configurations (first number is the configuration ID; listed from best to worst according to the sum of ranks):
#>    tmax    temp
#> 21   12 30.9332
#> 1    28 40.3082
#> 3     3 65.3082
#> # 2026-01-28 22:19:57 UTC: Iteration 2 of 3
#> # experimentsUsed: 152
#> # remainingBudget: 348
#> # currentBudget: 174
#> # nbConfigurations: 27
...
#> 29   29    5 22.7613       21
#> 
#> # 2026-01-28 22:19:58 UTC: Elite configurations (first number is the configuration ID; listed from best to worst according to the sum of ranks):
#>    tmax    temp
#> 29    5 22.7613
#> 39    3 62.3892
#> 21   12 30.9332
#> # 2026-01-28 22:19:58 UTC: Iteration 3 of 3
#> # experimentsUsed: 323
#> # remainingBudget: 177
#> # currentBudget: 177
#> # nbConfigurations: 24
...
#> 29   29    5 22.7613       21
#> 
#> # 2026-01-28 22:20:00 UTC: Elite configurations (first number is the configuration ID; listed from best to worst according to the sum of ranks):
#>    tmax    temp
#> 29    5 22.7613
#> 70    6 22.0074
#> 71   12 35.5064
#> # 2026-01-28 22:20:00 UTC: Stopped because there is not enough budget left to race more than the minimum (3).
...
#> # number of elites: 3
#> # nbConfigurations: 3
#> # Total CPU user time: 3.532, CPU sys time: 0.003, Wall-clock time: 3.535
#> # 2026-01-28 22:20:00 UTC: Starting post-selection:
#> # Configurations selected: 29, 70, 71, 39, 21, 52.
#> # Pending instances: 0, 0, 0, 0, 0, 0.
#> # 2026-01-28 22:20:00 UTC: seed: 1278720907
#> # Configurations: 6
...
#> 70    6 22.0074
#> 39    3 62.3892
#> # Total CPU user time: 3.599, CPU sys time: 0.005, Wall-clock time: 3.604
