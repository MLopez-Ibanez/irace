...
paramDef <-
  rbind (
         ...
         c("hookRun", "", "--hook-run", "./hook-run", 
          "The script called by Race for each candidate that launches the program to be tuned. See hooks/."),
         c("hookEvaluate", "", "--hook-evaluate", "./hook-evaluate", 
          "The scrip that provides a numeric value for each candidate. See hooks/."),
