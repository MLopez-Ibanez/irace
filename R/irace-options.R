...
"trainInstancesFile", "configurationsFile", "forbiddenExps", 
"forbiddenFile", "targetRunner", "targetRunnerLauncher", "targetRunnerLauncherArgs", 
...
"boundPar", "boundAsTimeout", "postselection", "aclib", "quiet"
), type = c("x", "x", "x", "x", "p", "p", "p", "p", "p", "p", 
"s", "x", "p", "p", "p", "x", "p", "p", "p", "s", "i", "x", "x", 
"p", "i", "i", "r", "r", "i", "i", "i", "i", "b", "s", "i", "i", 
"i", "i", "i", "r", "b", "i", "i", "b", "b", "s", "b", "r", "p", 
"p", "x", "i", "b", "b", "i", "i", "x", "b", "s", "s", "i", "i", 
"i", "b", "r", "b", "b"), short = c("-h", "-v", "-c", "-i", "", 
"-s", "-p", "", "-l", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "-e", "", "", "", "", "", "", "", "", "", "", "", "", 
"-q"), long = c("--help", "--version", "--check", "--init", "--only-test", 
...
"--target-runner-launcher", "--target-runner-args", "--target-runner-retries", 
"", "", "--target-evaluator", "--max-experiments", "--max-time", 
"--budget-estimation", "--min-measurable-time", "--digits", "--debug-level", 
...
"--aclib", "--quiet"), default = c(NA, NA, NA, "", "", "./scenario.txt", 
"./parameters.txt", "./", "./irace.Rdata", "", "", "", "./Instances", 
"", "", "", "", "./target-runner", "", "{targetRunner} {targetRunnerArgs}", 
"0", "", "", "", "0", "0", "0.02", "0.01", "4", "0", "0", "0", 
"1", "", "5", "1", "0", "0", "5", "0.95", "0", NA, "0", "1", 
"0", "0", "1", "", "", "", "", "1", "0", "1", "1", "2", "", "0", 
"median", "candidate", "0", "0", "1", "1", "0", "0", "0"), domain = c(NA, 
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 
"F-test,t-test,t-test-holm,t-test-bonferroni", NA, NA, NA, NA, 
NA, NA, NA, NA, NA, NA, NA, "sge,pbs,torque,slurm,htcondor", 
NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "median,mean,worst,best", 
"instance,candidate", NA, NA, NA, NA, NA, NA, NA), description = c("Show this help.", 
...
"Script called for each configuration that executes the target algorithm to be tuned. See the templates and examples provided.", 
"An executable that will be used to launch the target runner, when targetRunner cannot be executed directly (.e.g, a Python script in Windows).", 
...
"Reduce the output generated by irace to a minimum.")), row.names = c(".help", 
".version", ".check", ".init", ".onlytest", "scenarioFile", "parameterFile", 
"execDir", "logFile", "recoveryFile", "instances", "initConfigurations", 
"trainInstancesDir", "trainInstancesFile", "configurationsFile", 
"forbiddenExps", "forbiddenFile", "targetRunner", "targetRunnerLauncher", 
"targetRunnerLauncherArgs", "targetRunnerRetries", "targetRunnerData", 
"targetRunnerParallel", "targetEvaluator", "maxExperiments", 
"maxTime", "budgetEstimation", "minMeasurableTime", "digits", 
"debugLevel", "nbIterations", "nbExperimentsPerIteration", "sampleInstances", 
