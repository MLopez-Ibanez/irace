...
"x", "x", "x", "p", "p", "p", "p", "p", "p", "s", "x", "p", "p", 
"p", "x", "p", "p", "p", "s", "i", "x", "x", "p", "i", "i", "r", 
"r", "i", "i", "i", "i", "b", "s", "i", "i", "i", "i", "i", "r", 
"b", "i", "i", "b", "b", "s", "b", "r", "p", "p", "x", "i", "b", 
"b", "i", "i", "x", "b", "s", "s", "i", "i", "i", "b", "r", "b"
), short = c("-h", "-v", "-c", "-i", "", "-s", "-p", "", "-l", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
"", "", "", "", "", "", "", "", "", "", "", "", "-e", "", "", 
"", "", "", "", "", "", "", "", "", ""), long = c("--help", "--version", 
"--check", "--init", "--only-test", "--scenario", "--parameter-file", 
...
"--postselection", "--aclib"), default = c(NA, NA, NA, "", "", 
"./scenario.txt", "./parameters.txt", "./", "./irace.Rdata", 
"", "", "", "./Instances", "", "", "", "", "./target-runner", 
"", "{targetRunner} {targetRunnerArgs}", "0", "", "", "", "0", 
...
)), row.names = c(".help", ".version", ".check", ".init", ".onlytest", 
