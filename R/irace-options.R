...
"x", "p", "p", "p", "s", "i", "x", "x", "p", "i", "i", "r", "r", 
"i", "i", "i", "i", "b", "s", "i", "i", "i", "i", "i", "r", "b", 
"i", "i", "b", "b", "s", "b", "r", "p", "p", "x", "i", "b", "b", 
"i", "i", "x", "b", "s", "s", "i", "i", "i", "b", "r", "b"), 
    short = c("-h", "-v", "-c", "", "-s", "-p", "", "-l", "", 
    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
    "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
    "", "", "", "", "", "", "", "", "", "", "", "", "", "-e", 
    ...
    "--target-runner-retries", "", "", "--target-evaluator", 
    "--max-experiments", "--max-time", "--budget-estimation", 
    "--min-measurable-time", "--digits", "--debug-level", "--iterations", 
    "--experiments-per-iteration", "--sample-instances", "--test-type", 
    "--first-test", "--each-test", "--min-survival", "--num-configurations", 
    "--mu", "--confidence", "--deterministic", "--seed", "--parallel", 
    "--load-balancing", "--mpi", "--batchmode", "--soft-restart", 
    "--soft-restart-threshold", "--test-instances-dir", "--test-instances-file", 
    "", "--test-num-elites", "--test-iteration-elites", "--elitist", 
    ...
    "0", "", "", "", "0", "0", "0.02", "0.01", "4", "0", "0", 
    "0", "1", "", "5", "1", "0", "0", "5", "0.95", "0", NA, "0", 
    "1", "0", "0", "1", "", "", "", "", "1", "0", "1", "1", "2", 
    "", "0", "median", "candidate", "0", "0", "1", "1", "0", 
    "0"), description = c("Show this help.", "Show irace package version.", 
