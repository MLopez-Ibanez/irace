...
"maxExperiments"             i    ""     "--max-experiments"            1000               "The maximum number of runs (invocations of targetRunner) that will be performed. It determines the maximum budget of experiments for the tuning."
...
"deterministic"              b    ""     "--deterministic"              0                  "Indicates if the target algorithm is deterministic, if enabled instances will be used only one time."
