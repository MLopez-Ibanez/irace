...
"forbiddenExps"              ""     ""                   ""                 ""
"forbiddenFile"              ""     "--forbidden-file"   ""                 "A file containing a list of logical expressions that cannot be true for any evaluated candidate. If empty or NULL, do not use a file."
