...
6.  git ci -a -m “Prepare to release version X.Y”

7.  make examples \# Takes a few hours. Inspect the examples in the
    vignette.

8.  make revdepcheck \# Takes a few hours

9.  make releasebuild \# Inspect the output for strange files!
