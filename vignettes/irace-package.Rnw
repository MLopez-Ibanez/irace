...
%
\begin{center}
\small\code{<config\_id>\ <instance\_id>\ <seed>\ <instance>\ [<extra\_instance\_params>]\ <command\_line>}
\end{center}
%
\begin{description}
\item \code{configuration id} : The numeric identifier uniquely identifies a configuration.
  ...
  \item \code{extra instance parameters}: User-defined parameters associated to the instance.
