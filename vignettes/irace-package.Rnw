...
<<trainEvo, fig.pos="H", fig.align="center", out.width='0.75\\textwidth', fig.cap="Training set performance of the best-so-far configuration over number of experiments.", prompt=FALSE, eval=TRUE, comment="">>=
...
# Get the mean value of all experiments executed up to each iteration for the best configuration of that iteration.
...
<<testEvo, fig.pos="H", fig.align="center", out.width='0.75\\textwidth', fig.cap="Testing set performance of the best-so-far configuration over number of experiments.", prompt=FALSE, eval=TRUE, comment="">>=
# Get number of iterations
iters <- unique(iraceResults$experimentLog[, "iteration"])
# Get number of experiments (function evaluations) up to each iteration
fes <- cumsum(sapply(iters, function(k)
